...
// Data manipulation, data store, data load, state management
...
/**
 * App initialization:
 * 1) check if stored bookmarks are present in local storage
 *
 */
const init = function () {
